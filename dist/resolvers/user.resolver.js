...
exports.resolversUser = {
    Query: {
        getUser: (_, args, context) => __awaiter(void 0, void 0, void 0, function* () {
            const infoUser = yield user_model_1.default.findOne({ token: context["user"].token, deleted: false });
            if (infoUser) {
                return {
                    code: 200,
                    message: "Thành công!",
    ...
    Mutation: {
        ...
        loginUser: (_, args) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (infoUser.password !== (0, md5_1.default)(password)) {
                return {
                    code: 400,
        ...
        deleteUser: (_, args) => __awaiter(void 0, void 0, void 0, function* () {
            const { id } = args;
            yield user_model_1.default.updateOne({ _id: id }, { deleted: true, deletedAt: new Date() });
            return "Delete user successfully";
        }),
        updateUser: (_, args) => __awaiter(void 0, void 0, void 0, function* () {
            const { id, user } = args;
            yield user_model_1.default.updateOne({ _id: id, deleted: false }, user);
